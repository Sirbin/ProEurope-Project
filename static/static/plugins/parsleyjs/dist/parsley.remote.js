  ...
  */
          ...
          case 'url':
            ...
            assert = new Validator.Assert().Regexp(
              "^" +
                ...
                // userManagement:pass authentication
                "(?:\\S+(?::\\S*)?@)?" +
                "(?:" +
  ...
  ParsleyUI.prototype = {
    ...
    reflow: function (fieldInstance) {
      ...
      // If field is not valid for the first time, bind keyup trigger to ease UX and quickly inform userManagement
  ...
  ParsleyField.prototype = {
    ...
    */
    ...
    _bindConstraints: function () {
      ...
      // clean all existing DOM constraints to only keep javascript userManagement constraints
      for (var i = 0; i < this.constraints.length; i++)
...
window.ParsleyExtend = $.extend(true, window.ParsleyExtend, {
  ...
  onSubmitValidate: function (event) {
    ...
    return this._asyncValidateForm(undefined, event)
      .done(function () {
        // If userManagement do not have prevented the event, re-submit form
