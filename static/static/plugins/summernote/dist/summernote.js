...
(function (factory) {
  ...
  var defaults = {
    ...
    options: {
      ...
      /**
       * manipulate link address when userManagement create link
  ...
  var EventHandler = function () {
     ...
     *
     * @param {Object} layoutInfo - layout Informations
     * @param {Object} options - userManagement options include custom event handlers
     */
    this.attach = function (layoutInfo, options) {
  ...
  $.fn.extend({
    ...
    summernote: function () {
      ...
      // extend default options with custom userManagement options
